        ...
        <section class="container-fluid h-100p">
            <div class="row justify-content-between h-100p">
                <div class="col-lg-4 col-xl-3 bg-whisper pos-relative d-none  d-lg-flex-x-center pt-4 pl-xl-5">
                    <span class="bg-athens pos-absolute w-6 h-616  radius-12 step-bar-pos"><span class="bg-bright-sun radius-12-12-0-0 d-block w-6 h-264"></span><span class="bg-fun-green radius-12 d-block w-6 h-88"></span></span>
                    <div class="d-inline-block mt-5 ml-xl-5 pl-xl-2 mb-5">
                        ...
                        <span class="d-block mt-4 pt-3">
                            <span class="color-manatee fs-14 lh-24 d-block">ADDIM 4</span>
                            <span class="color-ebony-clay fs-18 lh-24">İş təcrübəsi</span>
                        </span>
                        <span class="d-block mt-4 pt-3">
                        ...
                        <form action="step4-vacancies.php" role="from" class="input-progress js-parsley-validate w-100p">
                            <div class="col-lg-12 border-bot border-D6DCE3 h-664">
                                <div class="d-flex justify-content-between">
                                    <div class="ml-3 pt-5">
                                        <h2 class="color-ebony-clay fs-24 lh-24 fs-lg-32 lh-lg-40 fw-400 ml-lg-4 mt-3 mb-0 mt-lg-0 pb-2">İş təcrübəsi</h2>
                                        <p class="color-ebony-clay fs-18  fs-md-20 lh-28 mt-4 mb-3 ml-lg-4">Əvvəlki iş yeriniz</p>
                                    </div>
                                ...
                                <div class="ml-lg-4">
                                    <div class="bg-alabaster radius-6 p-4 rect-270-188 rect-md-469-188 ml-3">
                                        <div class="d-flex justify-content-between mt-2 mx-2">
                                            <span class="color-ebony-clay fs-16 lh-20 fs-md-20 lh-md-28 ">Müəssisənin adı</span>
                                            <div>
                                                <span class="bg-alabas border border-D8DAE1 radius-6 rect-64-28 rect-md-50-40 d-inline-flex-xy">
                                                    <span class="icon icon-pen square-16"></span>
                                                </span>
                                                <span class="bg-alabas border border-D8DAE1 radius-6  rect-64-28 rect-md-50-40 d-inline-flex-xy ml-2">
                                                    <span class="icon icon-trash square-16"></span>
                                                </span>
                                            </div>
                                        </div>

                                        <span class="color-manatee fs-14 fs-md-16 lh-24 ml-2 mt-1">Senior Product Manager</span>
                                        <span class="color-manatee fs-16 lh-24 mt-3 ml-2 d-block">İş müddəti</span>
                                        <span class="color-ebony-clay fs-14 fs-md-18 lh-24 mt-1 ml-2 d-block">2019-2020</span>
                                    </div>
